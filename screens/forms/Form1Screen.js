    ...
    <View style={[styles.container, { overflow: 'visible' }]}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        > 
          ...
          <CoordinateInput />
          <InputBox title="Nama User" />
          <DropdownPicker title="Jabatan User" options={jabatan} />
          <MultiSelectCheckbox title="Tujuan Kunjungan" options={options} selected={selected} onChange={setSelected} />
          <DropdownPicker title="Status Kunjungan" options={status_kunjungan} />
          <CameraInput title="Dokumentasi kunjungan 0/1" />
          <InputBox title="Note Kunjungan (Hasil/Update Kunjungan)" />
